...
const I18N_DICT = {
  pt: {
    ...
    'hero.cartascacadashoje': 'cartas caçadas hoje',
    ...
    'rankings.subtitulopagina': 'As melhores builds e os melhores garimpeiros de cartas, publicados pela comunidade.',
    'rankings.topbuilds': 'Top Builds', 'rankings.todas': 'Todas', 'rankings.criador': 'Criador',
    'rankings.cenario': 'Cenário', 'rankings.cartaspublicadas': 'Cartas publicadas', 'rankings.medianota': 'Nota média',
    'rankings.carregando': 'Carregando…',
    'rankings.semresultados': 'Ainda não tem nenhuma carta publicada aqui. Seja o primeiro!',
    'rankings.erro': 'Não consegui carregar o ranking agora. Tenta de novo em um instante.',
    'rankings.comopublicar': 'Quer aparecer aqui? Vá até o seu <a href="inventario.html" style="color:var(--accent-hover)">Inventário</a> e publique uma carta (exclusivo do plano <a href="planos.html" style="color:var(--accent-hover)">Premium</a>).',
    ...
    'inv.tab.arquivar': '📦 Arquivar',
    'inv.dica.arquivar': 'Cartas arquivadas ficam guardadas pra sempre, fora da lista principal. Desarquive quando quiser ver de novo.',
    'inv.vazio.arquivar': 'Nenhuma carta arquivada ainda.',
    'inv.raridade.todas': 'Todas', 'inv.raridade.lendaria': 'Lendária', 'inv.raridade.epica': 'Épica',
    'inv.raridade.rara': 'Rara', 'inv.raridade.comum': 'Comum',
    'inv.arquivado.carta': 'Carta', 'inv.desarquivar': 'Desarquivar',
    'inv.toast.arquivado.titulo': '📦 Arquivado', 'inv.toast.arquivado.desc': 'guardado pra sempre na aba Arquivar.',
    'inv.toast.desarquivado.titulo': '♻️ Desarquivado', 'inv.toast.desarquivado.desc': 'voltou para o inventário.',
  ...
  en: {
    ...
    'hero.cartascacadashoje': 'cards hunted today',
    ...
    'rankings.subtitulopagina': 'The best builds and the best card hunters, published by the community.',
    'rankings.topbuilds': 'Top Builds', 'rankings.todas': 'All', 'rankings.criador': 'Creator',
    'rankings.cenario': 'Scenario', 'rankings.cartaspublicadas': 'Published cards', 'rankings.medianota': 'Average score',
    'rankings.carregando': 'Loading…',
    'rankings.semresultados': "No card published here yet. Be the first!",
    'rankings.erro': 'Could not load the ranking right now. Try again in a moment.',
    'rankings.comopublicar': 'Want to show up here? Go to your <a href="inventario.html" style="color:var(--accent-hover)">Inventory</a> and publish a card (Premium plan only).',
    ...
    'inv.tab.arquivar': '📦 Archive',
    'inv.dica.arquivar': 'Archived cards stay saved forever, off the main list. Unarchive whenever you want to see them again.',
    'inv.vazio.arquivar': 'No archived cards yet.',
    'inv.raridade.todas': 'All', 'inv.raridade.lendaria': 'Legendary', 'inv.raridade.epica': 'Epic',
    'inv.raridade.rara': 'Rare', 'inv.raridade.comum': 'Common',
    'inv.arquivado.carta': 'Card', 'inv.desarquivar': 'Unarchive',
    'inv.toast.arquivado.titulo': '📦 Archived', 'inv.toast.arquivado.desc': 'saved forever in the Archive tab.',
    'inv.toast.desarquivado.titulo': '♻️ Unarchived', 'inv.toast.desarquivado.desc': 'is back in your inventory.',
